    ...
    <div className="max-w-5xl mx-auto px-4 pt-6 pb-4">
      ...
      <div className="mb-6 animate-slide-up">
        <h1 className="text-4xl sm:text-5xl font-black text-slate-800 tracking-tight">
          {user ? `Hey ${user.name}!` : "Goal Kick!"}
        </h1>
        <p className="text-base sm:text-lg font-semibold text-slate-500 mt-1">
        ...
        <>
          ...
          <section className="mb-8 animate-slide-up" style={{ animationDelay: "0.1s" }}>
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-slate-800">
                  {hasMatchesToday ? "Today's Matches" : "Coming Up"}
                </h2>
              </div>
              {displayMatches.length > 0 && (
                ...
                >
                  See all <ChevronRight size={16} strokeWidth={3} />
                </button>
              )}
            </div>
            ...
            {displayMatches.length === 0 ? (
              <div className="card-tactile p-8 text-center">
                ...
                <p className="text-slate-500 font-semibold text-lg">No matches right now</p>
                <p className="text-slate-400 font-medium text-sm mt-1">Check back later or browse the leagues!</p>
              </div>
            ) : (
          ...
          {stories.length > 0 && (
            <section className="mb-8 animate-slide-up" style={{ animationDelay: "0.2s" }}>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-slate-800">Match Stories</h2>
              </div>
          ...
          <section className="animate-slide-up" style={{ animationDelay: "0.3s" }}>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-800">Explore Leagues</h2>
            </div>
              ...
              {leagues.map((league, i) => (
                <button
                  ...
                  style={{
                    ...
                    boxShadow: `0 6px 0 0 ${league.color}88`,
                  }}
                >
