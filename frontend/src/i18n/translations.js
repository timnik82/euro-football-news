...
const translations = {
  en: {
    ...
    landing: {
      ...
      previewEmpty: "No matches right now",
    },
    login: {
      ...
      googleDivider: "or keep going with email",
      name: "Your Name",
  ...
  ru: {
    ...
    landing: {
      ...
      todayLabel: "Сегодня",
      upcomingLabel: "Ближайшие матчи",
      previewLoading: "Загружаем матчи дня...",
      previewEmpty: "Сейчас нет матчей",
    },
    login: {
      ...
      googleDivider: "или продолжить по почте",
      name: "Твоё имя",
  ...
  pt: {
    ...
    landing: {
      ...
      todayLabel: "Hoje",
      upcomingLabel: "Proximos jogos",
      previewLoading: "A carregar os jogos de hoje...",
      previewEmpty: "Sem jogos agora",
    },
    login: {
      ...
      googleDivider: "ou continuar com email",
      name: "O teu nome",
