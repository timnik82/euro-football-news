...
const translations = {
  en: {
    ...
    admin: {
      title: "Story Diagnostics",
      subtitle: "Check which story sources found exact match reports and which ones failed.",
      back: "Back home",
      refreshList: "Refresh list",
      refreshMatch: "Run source check",
      refreshDone: "Diagnostics updated",
      refreshError: "Could not refresh this match",
      checking: "Checking sources...",
      loadError: "Could not load diagnostics",
      checked: "Checked",
      sourceFound: "Sources found",
      fallbackStories: "Fallback stories",
      score: "Score",
      sources: "Sources",
      sourceSnippets: "Short from sources",
      updated: "Updated",
      queries: "Queries",
      candidates: "Articles",
      matches: "Matches",
      neverChecked: "Not yet",
      noDiagnostics: "No provider check saved yet.",
      empty: "No recent finished matches to check.",
      status: {
        matched: "Matched",
  ...
  ru: {
    ...
    admin: {
      title: "Диагностика историй",
      subtitle: "Проверка показывает, какие источники нашли точный обзор матча, а какие не сработали.",
      back: "На главную",
      refreshList: "Обновить список",
      refreshMatch: "Проверить источники",
      refreshDone: "Диагностика обновлена",
      refreshError: "Не удалось обновить этот матч",
      checking: "Проверяем источники...",
      loadError: "Не удалось загрузить диагностику",
      checked: "Проверено",
      sourceFound: "Найдены источники",
      fallbackStories: "Истории по счёту",
      score: "Счёт",
      sources: "Источники",
      sourceSnippets: "Коротко из источников",
      updated: "Обновлено",
      queries: "Запросы",
      candidates: "Статьи",
      matches: "Совпадения",
      neverChecked: "Ещё нет",
      noDiagnostics: "Проверка источников ещё не сохранена.",
      empty: "Нет недавних завершённых матчей для проверки.",
      status: {
        matched: "Найдено",
        source_found: "Источник найден",
        no_match: "Нет точного матча",
  ...
  pt: {
    ...
    admin: {
      title: "Diagnóstico de Histórias",
      subtitle: "Vê que fontes encontraram relatos exatos do jogo e quais falharam.",
      back: "Voltar ao início",
      refreshList: "Atualizar lista",
      refreshMatch: "Verificar fontes",
      refreshDone: "Diagnóstico atualizado",
      refreshError: "Não foi possível atualizar este jogo",
      checking: "A verificar fontes...",
      loadError: "Não foi possível carregar o diagnóstico",
      checked: "Verificados",
      sourceFound: "Fontes encontradas",
      fallbackStories: "Histórias por resultado",
      score: "Resultado",
      sources: "Fontes",
      sourceSnippets: "Resumo das fontes",
      updated: "Atualizado",
      queries: "Pesquisas",
      candidates: "Artigos",
      matches: "Correspondências",
      neverChecked: "Ainda não",
      noDiagnostics: "Nenhuma verificação de fonte guardada ainda.",
      empty: "Sem jogos recentes terminados para verificar.",
      status: {
        matched: "Encontrado",
        source_found: "Fonte encontrada",
        no_match: "Sem jogo exato",
